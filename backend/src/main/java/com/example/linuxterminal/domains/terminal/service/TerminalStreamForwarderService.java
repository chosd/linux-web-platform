...
@Slf4j
@Service
public class TerminalStreamForwarderService {

    private final TerminalWebSocketRepository terminalWebSocketRepository;

    public TerminalStreamForwarderService(TerminalWebSocketRepository terminalWebSocketRepository) {
        this.terminalWebSocketRepository = terminalWebSocketRepository;
    }
    ...
    private void forwardStream(TerminalSession terminalSession, InputStream inputStream) {
        ...
        try (BufferedReader reader = new BufferedReader(
            ...
            while ((read = reader.read(buffer)) != -1) {
                ...
                terminalWebSocketRepository.sendText(terminalSession.getWebSocketSession(), chunk);
            }
